...
def test_handle_update_repository_form_rolls_back_on_known_submit_error():
    ...
    result = update_form_service.handle_update_repository_form(
        ...
        relocate_repository_local_dir=lambda **_kwargs: {
            "reason": "same_path", "old_path": "", "new_path": "", "error": None, "message": ""},
        undo_repository_local_dir_move=lambda **_kwargs: (True, ""),
        BLOCKING_REASONS=frozenset({"target_exists", "failed"}),
        REASON_MOVED="moved",
        log_print=log_print,
